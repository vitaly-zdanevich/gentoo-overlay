...
# Youta and its Rust dependencies, including bundled SQLite, are statically
# included. These licenses match the corresponding source package.
LICENSE="
...
# These flags select the corresponding output support in the system mpv
# package. Youta delegates audio output to mpv at runtime.
IUSE="+alsa jack pipewire pulseaudio"
